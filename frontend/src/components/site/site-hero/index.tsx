...
export default function SiteHero() {
  return (
    <section className="flex min-h-[45vh] items-center justify-between border-b">
      <div className="space-y-5 w-1/2">
        <div className="text-5xl font-extrabold tracking-wider text-primary space-y-2">
          <h1>Hot. Fresh. </h1>
          <h1>At Your Door in No Time.</h1>
        </div>

        <p className="tracking-wider font-medium text-lg pr-12 leading-8">
