...
import { authMiddleware, isAdminMiddleware, validateUserIdParam } from "../middlewares";
...
adminRoutes.put(ADMIN_ROUTES.ENABLE_DISABLE_PRODUCT, authMiddleware, isAdminMiddleware, admin.enableDisableProduct);
adminRoutes.delete(
