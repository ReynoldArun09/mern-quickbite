...
import { authMiddleware, ValidateObjectParamId } from "../middlewares";
...
cartRoutes.post(CART_ROUTES.REMOVE_FROM_CART, ValidateObjectParamId("productId"), authMiddleware, cart.removeFromCart);
